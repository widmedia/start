<?php
  ...
  // a3: add new user function. do=2. linked from the insecure site
  // b: secured
  // b1: link with userid and key: do=3&userid=7&key=ABCDEF1234...
  ...
  function printEntryPoint($dbConnection) {
    ...
    // selection between
    // a: login as test user, try stuff (test user does have a pw and a key)
    ...
    <div class="row"><div class="four columns">email: </div><div class="eight columns"><input name="email" type="email" maxlength="127" value="" required size="20"></div></div>
    <div class="row"><div class="four columns">password: </div><div class="eight columns"><input name="password" type="password" maxlength="63" value="" required size="20"></div></div>
    ...
    <div class="row" style="font-size: smaller;">
      <div class="six columns"><a href="editUser.php?do=9">open a new account</a></div>
