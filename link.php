 <?php
  ...
  <body><br>Something related to the data base went wrong (in file '.htmlentities($_SERVER['SCRIPT_NAME']).')... well, that doesn\'t help that much, does it?<br>But you might still want to inform me (sali@widmedia.ch) or just try again later</body></html>');
